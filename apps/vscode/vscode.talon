...
search fold: user.vscode("search.action.collapseSearchResults")
search unfold: user.vscode("search.action.expandSearchResults")
search results: user.vscode("search.action.focusSearchList")
search all: user.vscode("workbench.action.findInFiles")
search: key(cmd-f)
...
file fold: user.vscode("workbench.files.action.collapseExplorerFolders")
...
mark list here: user.vscode("bookmarks.list")
...
break point next: user.vscode("editor.debug.action.goToNextBreakpoint")
break point last: user.vscode("editor.debug.action.goToPreviousBreakpoint")
break point trash all: user.vscode("workbench.debug.viewlet.action.removeAllBreakpoints")
break point enable: user.vscode("workbench.debug.viewlet.action.enableAllBreakpoints")
break point disable: user.vscode("workbench.debug.viewlet.action.disableAllBreakpoints")
step over: user.vscode("workbench.action.debug.stepOver")
debug hover: user.vscode("editor.debug.action.showDebugHover")
debug next: user.vscode("workbench.action.debug.nextConsole")
debug last: user.vscode("workbench.action.debug.prevConsole")
debug watch: user.vscode("editor.debug.action.selectionToWatch")
debug focus watch: user.vscode("workbench.debug.action.focusWatchView")
debug focus break point: user.vscode("workbench.debug.action.focusBreakpointsView")
...
debug stop all:
    ...
    user.vscode("workbench.action.debug.stop")
    sleep(300ms)
    user.vscode("workbench.action.terminal.killAll")
...
terminal trash all: user.vscode("workbench.action.terminal.killAll")
